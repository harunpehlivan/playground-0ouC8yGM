...
The Beam Search is also a tree search algorithm but the data are sorted using a score fonction and the collection has a limited size. The algorithm is very fast but the results are not always guaranteed or optimal.
